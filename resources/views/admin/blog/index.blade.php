        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div
                ...
                <div class="flex justify-between mb-4">
                    <h1 class="text-2xl font-semibold">Portfolio Manage</h1>
                            ...
                            @foreach ($blogs as $key => $blog)
                                <tr>
                                    ...
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <p class="text-black dark:text-white">{{ $blog?->title }}</p>
                                    </td>
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <p class="text-black dark:text-white">{{ $blog?->category->name }}</p>
                                    </td>
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <img src="{{ asset('cv/' . ($blog ? $blog->image : '')) }}"
                                    ...
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <div class="flex items-center space-x-3.5">
                                            ...
                                            <a href="{{ route('blog.edit', $blog->id) }}" class="hover:text-primary">
                                            ...
                                            <a href="#"
                                                onclick="confirmDelete('{{ route('blog.delete', $blog->id) }}')"
