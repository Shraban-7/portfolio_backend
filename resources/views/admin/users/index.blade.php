        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div
                ...
                <div class="flex justify-between mb-4">
                    <h1 class="text-2xl font-semibold">User Manage</h1>
                    <a href="{{ route('user.create') }}" class="bg-primary py-2  px-4 text-white border rounded-lg">Create</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($users as $key => $user)
                                <tr>
                                    ...
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <p class="text-black dark:text-white">{{ $user?->user_name }}</p>
                                    </td>
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <p class="text-black dark:text-white">{{ $user?->email }}</p>
                                    </td>
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <p class="text-black dark:text-white">{{ config("user_role.{$user->role}", 'Unknown Role') }}</p>
                                    </td>
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
