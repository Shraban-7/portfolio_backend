        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div class="bg-white overflow-hidden  sm:rounded-lg  shadow-default dark:border-strokedark dark:bg-boxdark">
                <div class="p-6 text-gray-900">
                    ...
                    @endif
                    <h2 class="text-2xl font-semibold mb-4 capitalize">Add counter</h2>
                            ...
                            @foreach ($counters as $key => $counter)
                                <tr>
                                    ...
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <p class="text-black dark:text-white">{{ $counter?->title }}</p>
                                    </td>


                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <div class="flex items-center space-x-3.5">
                                            <a href="{{ route('counter.edit', $counter->id) }}" class="hover:text-primary">
